...
//
//    private final ConcurrentHashMap<String, FileSynchronizer> synchronizerTable = new ConcurrentHashMap<>(2);
//
...
//    }
//
//    public void addSynchronizer(String name, FileSynchronizer fileSynchronizer) {
//        synchronizerTable.putIfAbsent(name, fileSynchronizer);
//    }
//
//    public void start() {
//        for (Map.Entry<String, FileSynchronizer> synchronizerEntry : synchronizerTable.entrySet()) {
